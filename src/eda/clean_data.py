...
DATASET_NAME = "indian_pines"  # e.g. "ksc", "botswana", "salinas", "indian_pines", "paviaU", "vnir_uav"
...
DATASET_CONFIG = {
    ...
    "vnir_uav": {
        "format": "tif_csv",
        "tif_path": "VNIR.tif",       # your 87 GB cube
        "gt_csv_path": "VNIR_labels.csv",  # manually labeled CSV
...
# ---- Branch 2: UAV VNIR .tif + CSV GT ----
    ...
    row_col_label_cols = cfg.get("csv_row_col_label_cols", ("row", "col", "label"))
